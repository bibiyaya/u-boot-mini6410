...
# endif
	...
	ShaanxiNormalUniversityARMMenu();
	/*
...
void ShaanxiNormalUniversityARMMenu(void)
{
	while(1) {
		int c;
		printf("##### ShaanxiNormalUniversityARM U-Boot(" RELEASE_MARK ", " BOOT_MEDIA ") for 6410 #####\n");
